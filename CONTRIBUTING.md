# Contributing to podcast-feed-maker-vapor
...
- Test files go in `Tests/PodcastFeedVaporTests/`
- Use `#expect` and `#require` for assertions
- Use **VaporTesting** for HTTP tests (`import VaporTesting`)

## Pull Request Guidelines

- **Clear title** describing the change (e.g., "Add feed caching middleware")
...
- `Sources/PodcastFeedVapor/` — Vapor middleware library (middleware, routes, caching, Fluent mapping)
- `Tests/PodcastFeedVaporTests/` — tests using Swift Testing + VaporTesting
